...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-axon/node_modules/axon/lib/plugins/queue.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-axon/node_modules/axon/lib/plugins/queue.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-axon/node_modules/axon/lib/plugins/</a> &#187; queue.js</div>
</div>
<div class="body">
...
&nbsp;
     ...
     */
&nbsp;
<span class="cstat-no" title="statement not covered" >    sock.queue = [];</span>
&nbsp;
    /**
...
<span class="cstat-no" title="statement not covered" >      var prev = sock.queue;</span>
<span class="cstat-no" title="statement not covered" >      var len = prev.length;</span>
<span class="cstat-no" title="statement not covered" >      sock.queue = [];</span>
<span class="cstat-no" title="statement not covered" >      debug('flush %d messages', len);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      sock.emit('flush', prev);</span>
    });
&nbsp;
    /**
     * Pushes `msg` into `buf`.
     */
&nbsp;
<span class="cstat-no" title="statement not covered" >    sock.enqueue = <span class="fstat-no" title="function not covered" >function(msg){</span></span>
